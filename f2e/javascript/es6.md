...
log('gaoter', 1, 2) // gaoter [1, 2]
log('gaoter', 1, 2, 3) // gaoter [1, 2, 3]
```
...
// 字符串会以字符数组的形式做合并
Object.assign({}, 'gaoter') // {0: 'm', 1: 'a', 2: 'o', 3: 'm', 4: 'a', 5: 'o'}
...
```js
const obj = { name: 'gaoter', age: 18 }
Object.keys(obj) // ['name', 'age']
Object.values(obj) //  ['gaoter', 18]
Object.entries(obj) // [['name', 'gaoter'], ['age', 18]]
```
...
```js
Object.fromEntries([['name', 'gaoter']]) // {name: 'gaoter'}

/* Map 转对象 */
const map = new Map([['name', 'gaoter']])
Object.fromEntries(map) // {name: 'gaoter'}

/* 将查询字符串转为对象 */
const params = 'name=gaoter&age=18'
Object.fromEntries(new URLSearchParams(params)) // {name: 'gaoter', age: '18'}
```
...
<<< @/f2e/javascript/code/nullish-coalescing.js
...
[Promise 实现](https://github.com/gaoter1996/Promise) 简易实现、A+ 规范实现、原型方法、静态方法实现
