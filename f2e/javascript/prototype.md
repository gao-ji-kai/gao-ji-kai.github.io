...
// 对象实例
const person1 = new Person('gaoter')
console.log(person1) // Person {name: 'gaoter'}
```
...
console.log(person1.name, person2.name) // 'gaoter' 'gaoter'
```
...
// 对象实例
const person = new Person('gaoter')
